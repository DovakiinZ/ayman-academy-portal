          ...
          children: [
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  _DrawerItem(icon: Icons.home_rounded, label: t('الرئيسية', 'Dashboard') as String, onTap: () {
                    Navigator.pop(context);
                    navigationShell.goBranch(0);
                  }),
                  _DrawerItem(icon: Icons.book_rounded, label: t('موادي', 'My Courses') as String, onTap: () {
                    Navigator.pop(context);
                    navigationShell.goBranch(1);
                  }),
                  _DrawerItem(icon: Icons.receipt_long_rounded, label: t('الطلبات', 'Orders') as String, onTap: () {
                    Navigator.pop(context);
                    context.push(Routes.teacherOrders);
                  }),
                  _DrawerItem(icon: Icons.star_rounded, label: t('التقييمات', 'Reviews') as String, onTap: () {
                    Navigator.pop(context);
                  ...
                  _DrawerItem(icon: Icons.campaign_rounded, label: t('الإعلانات', 'Announcements') as String, onTap: () {
                    Navigator.pop(context);
                    navigationShell.goBranch(2);
                  }),
                  _DrawerItem(icon: Icons.workspace_premium_rounded, label: t('الشهادات', 'Certificates') as String, onTap: () {
                    Navigator.pop(context);
